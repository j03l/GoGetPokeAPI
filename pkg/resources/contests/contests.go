...
func SuperContestEffect(id string) (result models.SuperContestEffect, err error) {
	err = request.Do(fmt.Sprintf("super-contest-effect/%s", id), &result)
	return result, err
}
