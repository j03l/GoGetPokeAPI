...
func MoveBattleStyle(id string) (result models.MoveBattleStyle, err error) {
	err = request.Do(fmt.Sprintf("move-battle-style/%s", id), &result)
	return result, err
}
...
func MoveCategory(id string) (result models.MoveCategory, err error) {
	err = request.Do(fmt.Sprintf("move-category/%s", id), &result)
	return result, err
}
...
func MoveDamageClass(id string) (result models.MoveDamageClass, err error) {
	err = request.Do(fmt.Sprintf("move-damage-class/%s", id), &result)
	return result, err
}
